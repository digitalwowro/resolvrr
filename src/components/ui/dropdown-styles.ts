export const dropdownTriggerClass =
  "inline-flex h-9 max-w-full items-center justify-between gap-2 rounded-md border border-slate-300 bg-white px-3 font-normal text-slate-800 hover:bg-slate-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 disabled:cursor-not-allowed disabled:opacity-50";
