export const dropdownTriggerClass =
  "inline-flex h-9 max-w-full items-center justify-between gap-2 rounded-md border border-slate-300 bg-white px-3 text-sm font-medium text-slate-800 shadow-sm hover:bg-slate-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 disabled:cursor-not-allowed disabled:opacity-50";
...
export const dropdownOptionClass =
  "flex h-8 min-w-full items-center gap-2 rounded px-2 text-left text-sm outline-none";
